            ...
            <div class="row g-4 align-items-stretch">
                <div class="col-lg-7" data-aos="fade-right">
                    <div class="custom-card shadow-sm p-4 h-100">
                        ...
                        <div class="small text-muted mt-3">
                            <i class="bi bi-info-circle me-1"></i> Lokasi bisa kamu sesuaikan sesuai alamat resmi
                            instansi.
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-5" data-aos="fade-left">
                    <div class="contact-box shadow-lg p-5 h-100 d-flex flex-column">
                        ...
                        <div class="mt-auto pt-3">
                            <a href="mailto:dinkessumenep@gmail.com"
                                class="btn btn-warning w-100 rounded-pill fw-bold py-3 shadow">
