<x-app-layout>
    <style>
        ...
        .form-card {
            ...
            background: #fff;
            border-top: 5px solid #0dcaf0; /* Aksen warna cyan/biru muda untuk membedakan dengan surat masuk */
        }
    ...
    <div class="container-fluid py-4 px-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted small">ID Surat: <span class="badge bg-light text-dark border">#SK-{{ str_pad($data->id, 4, '0', STR_PAD_LEFT) }}</span></p>
            </div>
                    ...
                    <div class="row g-4">
                        <div class="col-md-7">
                            ...
                            @if ($data->file_surat)
                                <div class="file-preview-box">
                                    ...
                                    <a href="{{ asset('storage/'.$data->file_surat) }}" target="_blank" class="btn btn-sm btn-outline-primary px-3 rounded-pill">
                        ...
                        <div class="col-md-5">
                            ...
                            <select name="status" class="form-select">
                                <option value="Draft" {{ $data->status == 'Draft' ? 'selected' : '' }}>Draft (Arsip Internal)</option>
                                <option value="Dikirim" {{ $data->status == 'Dikirim' ? 'selected' : '' }}>Dikirim (Menunggu Respon)</option>
                                <option value="Selesai" {{ $data->status == 'Selesai' ? 'selected' : '' }}>Selesai (Terkonfirmasi)</option>
                            </select>
                        </div>
                    </div>
