                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" name="tanggal_surat" class="form-control"
                                value="{{ old('tanggal_surat', optional($data->tanggal_surat)->format('Y-m-d')) }}"
                                required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="jenis_surat" name="jenis_surat" class="form-select" required>
                                ...
                                <option value="surat_keputusan"
                                    {{ $currentJenis == 'surat_keputusan' ? 'selected' : '' }}>
                                    Surat Keputusan (SK)
                                </option>
                            </select>
                        ...
                        <div class="col-md-5">
                            ...
                            <select name="status" class="form-select">
                                ...
                                <option value="Dikirim"
                                    {{ old('status', $data->status) == 'Dikirim' ? 'selected' : '' }}>
                    ...
                    <div id="section-nota-dinas" style="display:none;">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="tembusan" class="form-control" rows="2" placeholder="Pisahkan dengan enter jika lebih dari 1">{{ old('tembusan', $data->tembusan) }}</textarea>
                            </div>
                            ...
                            <div class="col-md-12">
                                <label class="form-label"><i class="bi bi-body-text"></i>Isi Nota Dinas
                                    (Opsional)</label>
                                <textarea name="isi" class="form-control" rows="4" placeholder="(Opsional) tambahan isi nota dinas...">{{ old('isi', $data->isi) }}</textarea>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="npm" class="form-control"
                                    value="{{ old('npm', $data->npm ?? '') }}" placeholder="Contoh: 722621778">
                            </div>
                    ...
                    <div id="section-sk" style="display:none;">
                        ...
                        <div class="row g-4">
                            <div class="col-md-12">
                                ...
                                <div class="hint mt-1">Untuk SK, tulis format Menimbang/Mengingat/Memutuskan di kolom
                                    ini.</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nama_ttd" class="form-control"
                                value="{{ old('nama_ttd', $data->nama_ttd) }}" placeholder="Nama pejabat">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nip_ttd" class="form-control"
                                value="{{ old('nip_ttd', $data->nip_ttd) }}" placeholder="NIP pejabat">
                        </div>
                    </div>
